...
const LoginCard: React.FC = () => {
    return (
        <div className="items-center absolute justify-center w-[600px] flex flex-col h-[600px] bg-black/10 rounded-full shadow-[inset_-4px_-4px_5px_0px_rgba(255,255,255,0.25),inset_4px_4px_5px_0px_rgba(255,255,255,0.25)] backdrop-blur-[30px]" >
            ...
            <div className="w-[371px] h-[38px] hover:border-[2px] hover:border-[#F23768] hover:cursor-pointer flex items-center justify-center bg-[#ffffff] rounded-[10px] shadow-[28px_28px_50px_0px_rgba(17,17,17,0.25)] mt-5 placeholder-gray-500 transform hover:scale-100">
