const LogoutButton = () => {
  return (
    <div className="sm:w-[247px] flex items-center justify-between flex-row bg-[#636363] px-4 py-2 rounded-[400px]">
      <div className=" text-white text-left font-bold text-lg">
        Bem-vindo, [user]!
      </div>
